        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <svg viewBox="0 0 24 24" fill="#F4F4F4" className="absolute w-6 h-6 md:w-9 md:h-9 drop-shadow-lg" style={{ bottom: 'calc(15% + 10px)', right: 'calc(10% + 11px)' }}>
            ...
            >
              ...
              >
                <svg viewBox="0 0 24 24" fill="#F4F4F4" className="absolute w-8 h-8 md:w-11 md:h-11 drop-shadow-lg" style={{ bottom: 'calc(15% + 10px)', right: 'calc(10% + 5px)' }}>
