      ...
      >
        ...
        >
          ...
          <path
            ...
            className="fill-[#0f1d2b]"
          />
          <circle cx="27" cy="25" r="6" className="fill-[#1a2a3a]" />
          <circle cx="47" cy="25" r="6" className="fill-[#1a2a3a]" />
          <circle cx="67" cy="25" r="6" className="fill-[#1a2a3a]" />
          <path
            d="M286 17C286 13.6863 288.686 11 292 11H946C949.314 11 952 13.6863 952 17V35C952 38.3137 949.314 41 946 41H292C288.686 41 286 38.3137 286 35V17Z"
            className="fill-[#1a2a3a]"
          />
          <g className="mix-blend-luminosity" transform="translate(-250, 0)">
            <path
