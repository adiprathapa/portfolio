...
const variantClasses: Record<Variant, string> = {
  ...
  'outline-white':
    'inline-flex items-center justify-center rounded-xl border border-white/30 text-white px-6 py-3 text-sm font-medium hover:bg-white/10 transition-colors',
