        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <svg viewBox="0 0 24 24" fill="white" className="absolute w-6 h-6 md:w-9 md:h-9 drop-shadow-lg" style={{ bottom: '18%', right: '13%' }}>
            ...
            >
              ...
              >
                <svg viewBox="0 0 24 24" fill="white" className="absolute w-8 h-8 md:w-11 md:h-11 drop-shadow-lg" style={{ bottom: 'calc(15% + 5px)', right: 'calc(10% + 5px)' }}>
